...
class FileSyncClient:
    def __init__(self, host='localhost', port=8888, sync_folder='client_sync_folder', client_name='Client1'):
        self.host = host
        self.port = port
...
if __name__ == "__main__":
    ...
    client = FileSyncClient(sync_folder='client_sync_folder', client_name='Client1')
